...
create index if not exists idx_calendar_events_featured on public.calendar_events (featured) where featured = true;
...
insert into public.calendar_events (
  title, slug, description, start_date, end_date, date_precision,
  country, city, sport, category, event_type, event_status,
  federation, status, sort_order
) values
  (
    ...
    '2025-08-01', '2025-08-31', 'month',
    'Argentina', 'Buenos Aires', 'Fútbol Sala', 'interclubes', 'interclubs', 'finished',
    'FASDS', 'published', 10
  ),
  (
    ...
    'Brasil', 'São José dos Pinhais', 'Fútbol Sala', 'sub21', 'championship', 'finished',
    'CBDS', 'published', 20
  ),
  (
    'Torneo Interclubes de Fútbol Sala',
    ...
    '2026-10-11', '2026-10-18', 'full',
    'Uruguay', 'Florida', 'Fútbol Sala', 'interclubes', 'interclubs', 'confirmed',
    'CONSUDES', 'published', 30
  ),
  (
    'Torneo Interclubes de Fútbol Sala',
    'interclubes-futsal-paraguay-2027',
    'Torneo interclubes de fútbol sala con sede en Paraguay, programado para junio de 2027.',
    '2027-06-01', '2027-06-30', 'month',
    'Paraguay', null, 'Fútbol Sala', 'interclubes', 'interclubs', 'upcoming',
    'CONSUDES', 'published', 40
  ),
  (
    'Campeonato Sudamericano de Fútbol Sala – Sub-21',
    ...
    '2027-01-01', '2027-12-31', 'year',
    '', null, 'Fútbol Sala', 'sub21', 'championship', 'upcoming',
    'CONSUDES', 'published', 50
  ),
  (
    ...
    'Sede abierta a propuestas. Las federaciones interesadas pueden enviar su candidatura a CONSUDES.',
    '2027-01-01', '2027-12-31', 'year',
    '', null, 'Fútbol Sala', 'adulto', 'championship', 'upcoming',
    'CONSUDES', 'published', 60
  )
