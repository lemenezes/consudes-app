...
export const translations = {
  es: {
    ...
    admin: {
      ...
      finance: {
        pageTitle: "Finanzas",
        description:
          "Control interno de los movimientos financieros de CONSUDES.",
        exchangeReference: "Tipo de cambio de referencia",
        exchangeUpdatedAt: "actualizado el",
        exchangeSource: "Fuente: Banco Central de Brasil",
        newTransaction: "Nuevo movimiento",
        currentBalance: "Saldo actual",
        monthlyIncome: "Ingresos del mes",
        monthlyExpenses: "Egresos del mes",
        monthlyTransactions: "Movimientos del mes",
        transactions: "Movimientos",
        latestTransactions: "Últimos movimientos",
        financialFlow: "Flujo financiero",
        flowDescription: "Ingresos y egresos de los últimos 6 meses.",
        flowIncome: "Ingresos",
        flowExpenses: "Egresos",
        flowPeriod: "Abr 2026 - Sep 2026",
        ...
        totalTransactions: "Total de movimientos",
        ...
        methods: { pix: "Pix", transfer: "Transferencia" },
        examples: {
          registration: "Inscripción Interclubes",
          lodging: "Reserva de hotel para la delegación",
          donation: "Donación institucional"
        }
      },
      officialDocuments: {
        pageTitle: "Oficios",
        description: "Creación y gestión de los oficios de CONSUDES.",
        documentDetails: "Datos del oficio",
        newDocument: "Nuevo oficio",
        editDocument: "Editar oficio",
        content: "Contenido",
        translations: "Traducciones",
        pdf: "PDF",
        publication: "Publicación",
        email: "Correo electrónico",
        documentNumber: "Número del oficio",
        date: "Fecha",
        originalLanguage: "Idioma original",
        languages: { pt: "Portugués", es: "Español", en: "Inglés" },
        ...
        sentCount: "Enviados",
        searchPlaceholder: "Buscar por número, asunto o destinatario...",
        ...
        publicationEmail: "Publicación y correo electrónico",
        translationsDescription: "PT, ES y EN.",
        officialPdfDescription: "Generación usando el modelo de CONSUDES.",
        publicationEmailDescription: "Será configurado después.",
        showingRange: "Mostrando 1 a 4 de 24 oficios",
        numberShort: "N.º",
        attachmentsComingSoon:
          "La gestión de archivos estará disponible próximamente.",
        translationsHelp: "Prepare y revise el contenido en cada idioma.",
        generateTranslations: "Generar traducciones",
        translationPending: "Traducción pendiente",
        pdfHelp: "El modelo oficial de CONSUDES se aplicará próximamente.",
        preparePdf: "Preparar PDF oficial",
        publishOnSite: "Publicar en el sitio web",
        destinationSection: "Página o sección",
        ...
        attachPdf: "Anexar el PDF oficial",
        editor: {
          contentPlaceholder: "Escriba el cuerpo del oficio...",
          ...
          quote: "Cita / destacado",
          removeLink: "Eliminar enlace",
          insertLink: "Insertar enlace",
          insertImage: "Insertar imagen en el contenido",
      ...
      dashboard: {
        ...
        viewFederations: "Ver federaciones",
        viewGallery: "Ver galería",
        documentsTotal: "en total",
        viewDocuments: "Ver oficios",
        viewFinance: "Ver finanzas",
        showBalance: "Mostrar saldo",
        hideBalance: "Ocultar saldo",
        affiliatedSingular: "afiliada",
        affiliatedPlural: "afiliadas",
        albumSingular: "álbum",
        albumPlural: "álbumes",
        photos: "fotos",
      ...
      federationsList: {
        pageTitle: "Federaciones afiliadas",
        new: "Nueva federación",
        countSingular: "federación",
        countPlural: "federaciones",
        toggleView: "Cambiar visualización",
        cardsView: "Vista en tarjetas",
        listView: "Vista en lista",
        cards: "Tarjetas",
        list: "Lista",
        emptyTitle: "No hay federaciones registradas.",
        emptyDesc: "Usa el botón superior para agregar la primera.",
        country: "País",
        officialName: "Nombre oficial",
        actions: "Acciones",
        edit: "Editar",
        delete: "Eliminar",
        deleteTitle: "¿Eliminar {acronym}?"
      },
      galleryList: {
        ...
        emptyDesc: "Usa el botón superior para agregar el primero.",
        cover: "Portada",
        album: "Álbum",
        category: "Categoría",
        year: "Año",
        ...
        saveAlbumFirst: "Guarda el álbum antes de añadir fotos.",
        fillAlbumInfoFirst:
          "Completa la información del álbum antes de añadir fotos.",
        noChanges: "Sin cambios",
        removePhotoTitle: "Eliminar foto",
        removePhotoMessage: "¿Seguro que deseas eliminar esta foto?",
        removeSelectedTitle: "Eliminar fotos seleccionadas",
        removeSelectedMessageSingular:
          "¿Seguro que deseas eliminar 1 foto seleccionada?",
        removeSelectedMessagePlural:
          "¿Seguro que deseas eliminar {count} fotos seleccionadas?",
        remove: "Eliminar",
      ...
      reports: {
        ...
        pdfClickUpload: "Seleccionar PDF",
  ...
  pt: {
    ...
    admin: {
      ...
      finance: {
        ...
        description:
          "Controle interno das movimentações financeiras da CONSUDES.",
        exchangeReference: "Câmbio de referência",
        exchangeUpdatedAt: "atualizado em",
        exchangeSource: "Fonte: Banco Central do Brasil",
        newTransaction: "Nova movimentação",
        currentBalance: "Saldo atual",
        monthlyIncome: "Entradas no mês",
        monthlyExpenses: "Saídas no mês",
        monthlyTransactions: "Movimentações no mês",
        transactions: "Movimentações",
        latestTransactions: "Últimas movimentações",
        financialFlow: "Fluxo financeiro",
        flowDescription: "Entradas e saídas nos últimos 6 meses.",
        flowIncome: "Entradas",
        flowExpenses: "Saídas",
        flowPeriod: "Abr 2026 - Set 2026",
        periodSummary: "Resumo do período",
        totalIncome: "Total de entradas",
        totalExpenses: "Total de saídas",
        periodBalance: "Saldo no período",
        totalTransactions: "Total de movimentações",
        ...
        methods: { pix: "Pix", transfer: "Transferência" },
        examples: {
          registration: "Inscrição Interclubes",
          lodging: "Reserva hotel delegação",
          donation: "Doação institucional"
        }
      },
      officialDocuments: {
        pageTitle: "Ofícios",
        description: "Criação e gestão dos ofícios da CONSUDES.",
        documentDetails: "Dados do ofício",
        newDocument: "Novo ofício",
        editDocument: "Editar ofício",
        content: "Conteúdo",
        translations: "Traduções",
        pdf: "PDF",
        publication: "Publicação",
        email: "E-mail",
        documentNumber: "Número do ofício",
        date: "Data",
        originalLanguage: "Idioma original",
        languages: { pt: "Português", es: "Espanhol", en: "Inglês" },
        languagesLabel: "Idiomas",
        ...
        publishedCount: "Publicados",
        sentCount: "Enviados",
        searchPlaceholder: "Buscar por número, assunto ou destinatário...",
        ...
        sent: "Enviado",
        officialPdf: "PDF oficial",
        publicationEmail: "Publicação e e-mail",
        translationsDescription: "PT, ES e EN.",
        officialPdfDescription: "Geração usando o modelo da CONSUDES.",
        publicationEmailDescription: "Será configurado depois.",
        showingRange: "Mostrando 1 a 4 de 24 ofícios",
        numberShort: "Nº",
        attachmentsComingSoon:
          "A gestão de arquivos estará disponível em breve.",
        translationsHelp: "Prepare e revise o conteúdo em cada idioma.",
        generateTranslations: "Gerar traduções",
        translationPending: "Tradução pendente",
        pdfHelp: "O modelo oficial da CONSUDES será aplicado futuramente.",
        preparePdf: "Preparar PDF oficial",
        publishOnSite: "Publicar no site",
        destinationSection: "Página ou seção",
        selectSection: "Selecionar uma seção",
        sections: {
          news: "Notícias",
          transparency: "Transparência",
          calendar: "Calendário"
        ...
        attachPdf: "Anexar o PDF oficial",
        editor: {
          contentPlaceholder: "Escreva o corpo do ofício...",
          normalText: "Texto normal",
          smallText: "Pequeno",
          emphasis: "Destaque",
          heading2: "Título H2",
      ...
      dashboard: {
        ...
        viewTransparency: "Ver transparência",
        viewFederations: "Ver federações",
        viewGallery: "Ver galeria",
        documentsTotal: "no total",
        viewDocuments: "Ver ofícios",
        viewFinance: "Ver financeiro",
        showBalance: "Mostrar saldo",
        hideBalance: "Ocultar saldo",
        affiliatedSingular: "filiada",
        affiliatedPlural: "filiadas",
        albumSingular: "álbum",
        albumPlural: "álbuns",
        photos: "fotos",
        upcomingModules: "Próximos módulos",
      ...
      federationsList: {
        pageTitle: "Federações filiadas",
        new: "Nova federação",
        countSingular: "federação",
        countPlural: "federações",
        toggleView: "Alternar visualização",
        cardsView: "Visualização em cards",
        listView: "Visualização em lista",
        cards: "Cards",
        list: "Lista",
        emptyTitle: "Nenhuma federação cadastrada.",
        emptyDesc: "Use o botão acima para adicionar a primeira.",
        country: "País",
        officialName: "Nome oficial",
        actions: "Ações",
        edit: "Editar",
        delete: "Apagar",
        deleteTitle: "Apagar {acronym}?"
      },
      galleryList: {
        ...
        cards: "Cards",
        list: "Lista",
        emptyTitle: "Nenhum álbum cadastrado.",
        emptyDesc: "Use o botão acima para adicionar o primeiro.",
        cover: "Capa",
        album: "Álbum",
        category: "Categoria",
        year: "Ano",
        ...
        edit: "Editar",
        delete: "Apagar",
        deleteTitle: "Deletar álbum?",
        saveAlbumFirst: "Salve o álbum antes de adicionar fotos.",
        fillAlbumInfoFirst:
          "Preencha as informações do álbum antes de adicionar fotos.",
        noChanges: "Sem alterações",
        removePhotoTitle: "Remover foto",
        removePhotoMessage: "Tem certeza que deseja remover esta foto?",
        removeSelectedTitle: "Remover fotos selecionadas",
        removeSelectedMessageSingular:
          "Tem certeza que deseja remover 1 foto selecionada?",
        removeSelectedMessagePlural:
          "Tem certeza que deseja remover {count} fotos selecionadas?",
        remove: "Remover",
  ...
  en: {
    ...
    admin: {
      ...
      finance: {
        pageTitle: "Finance",
        description: "Internal control of CONSUDES financial transactions.",
        exchangeReference: "Reference exchange rate",
        exchangeUpdatedAt: "updated on",
        exchangeSource: "Source: Central Bank of Brazil",
        ...
        flowDescription: "Income and expenses over the last 6 months.",
        flowIncome: "Income",
        flowExpenses: "Expenses",
        flowPeriod: "Apr 2026 - Sep 2026",
        ...
        methods: { pix: "Pix", transfer: "Bank transfer" },
        examples: {
          registration: "Interclubs registration",
          lodging: "Delegation hotel booking",
          donation: "Institutional donation"
        }
      },
      officialDocuments: {
        pageTitle: "Official documents",
        description: "Creation and management of CONSUDES official documents.",
        documentDetails: "Official document details",
        newDocument: "New official document",
        editDocument: "Edit official document",
        content: "Content",
        ...
        sentCount: "Sent",
        searchPlaceholder: "Search by number, subject or recipient...",
        ...
        publicationEmail: "Publication and email",
        translationsDescription: "PT, ES and EN.",
        officialPdfDescription: "Generated using the CONSUDES template.",
        publicationEmailDescription: "Will be configured later.",
        showingRange: "Showing 1 to 4 of 24 official documents",
        numberShort: "No.",
        attachmentsComingSoon: "File management will be available soon.",
        translationsHelp: "Prepare and review the content in each language.",
        generateTranslations: "Generate translations",
        translationPending: "Translation pending",
        pdfHelp:
          "The official CONSUDES template will be applied in the future.",
        preparePdf: "Prepare official PDF",
        publishOnSite: "Publish on the website",
        destinationSection: "Page or section",
        ...
        attachPdf: "Attach the official PDF",
        editor: {
          contentPlaceholder: "Write the official document body...",
          ...
          insertImage: "Insert image in content",
      ...
      dashboard: {
        ...
        viewFederations: "View federations",
        viewGallery: "View gallery",
        documentsTotal: "in total",
        viewDocuments: "View official documents",
        viewFinance: "View finance",
        showBalance: "Show balance",
        hideBalance: "Hide balance",
        affiliatedSingular: "affiliated",
        affiliatedPlural: "affiliated",
        albumSingular: "album",
        albumPlural: "albums",
        photos: "photos",
      ...
      federationsList: {
        pageTitle: "Affiliated federations",
        new: "New federation",
        countSingular: "federation",
        countPlural: "federations",
        toggleView: "Toggle view",
        cardsView: "Card view",
        listView: "List view",
        cards: "Cards",
        list: "List",
        emptyTitle: "No federations registered.",
        emptyDesc: "Use the button above to add the first one.",
        country: "Country",
        officialName: "Official name",
        actions: "Actions",
        edit: "Edit",
        delete: "Delete",
        deleteTitle: "Delete {acronym}?"
      },
      galleryList: {
        ...
        cards: "Cards",
        list: "List",
        emptyTitle: "No albums registered.",
        emptyDesc: "Use the button above to add the first one.",
        cover: "Cover",
        album: "Album",
        category: "Category",
        ...
        saveAlbumFirst: "Save the album before adding photos.",
        fillAlbumInfoFirst: "Fill in the album details before adding photos.",
        noChanges: "No changes",
        removePhotoTitle: "Remove photo",
        removePhotoMessage: "Are you sure you want to remove this photo?",
        removeSelectedTitle: "Remove selected photos",
        removeSelectedMessageSingular:
          "Are you sure you want to remove 1 selected photo?",
        removeSelectedMessagePlural:
          "Are you sure you want to remove {count} selected photos?",
        remove: "Remove",
