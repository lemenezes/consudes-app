...
export const translations = {
  es: {
    ...
    admin: {
      ...
      groups: { content: "Contenido", institutional: "Institucional" },
      menuLabel: "Menú",
      logout: "Salir",
  ...
  pt: {
    ...
    admin: {
      ...
      groups: { content: "Conteúdo", institutional: "Institucional" },
      menuLabel: "Menu",
      logout: "Sair",
  ...
  en: {
    ...
    admin: {
      ...
      groups: { content: "Content", institutional: "Institutional" },
      menuLabel: "Menu",
      logout: "Sign out",
      ...
      officialDocuments: {
        ...
        pdfHelp: "The official CONSUDES template will be applied in the future.",
