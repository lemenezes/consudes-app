        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              <span className="font-medium text-[#1F2937]">&ldquo;{itemLabel}&rdquo;</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm text-[#1F2937] bg-[#F5F7FA] placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-400 transition-colors"
            />
          </div>
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg text-sm font-semibold text-white bg-red-600 hover:bg-red-700 active:bg-red-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
