...
function buildSocials(s: Federation['socials']): SocialLink[] {
  const links: SocialLink[] = [];
  if (s.website)   links.push({ href: s.website,   icon: <IconGlobe />,    label: 'Website' });
  if (s.instagram) links.push({ href: s.instagram, icon: <IconInstagram />, label: 'Instagram' });
  if (s.facebook)  links.push({ href: s.facebook,  icon: <IconFacebook />, label: 'Facebook' });
  if (s.youtube)   links.push({ href: s.youtube,   icon: <IconYoutube />,  label: 'YouTube' });
  if (s.twitter)   links.push({ href: s.twitter,   icon: <IconTwitter />,  label: 'X / Twitter' });
  if (s.linkedin)  links.push({ href: s.linkedin,  icon: <IconLinkedin />, label: 'LinkedIn' });
  if (s.tiktok)    links.push({ href: s.tiktok,    icon: <IconTiktok />,   label: 'TikTok' });
  if (s.flickr)    links.push({ href: s.flickr,    icon: <IconFlickr />,   label: 'Flickr' });
  return links;
}
