      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          <div className="inline-flex items-center gap-3">
            ...
            <div>
              <p className="font-['Cormorant_Garamond'] text-lg font-semibold text-[#0C5A86] dark:text-white tracking-wide">
                CONSUDES
              </p>
          ...
          <nav className="flex items-center gap-6 text-sm text-slate-500 dark:text-slate-400 flex-wrap">
            <a href="#sobre" className="hover:text-[#0C5A86] dark:hover:text-sky-400 transition-colors">
              Sobre
            </a>
            <a href="#programas" className="hover:text-[#0C5A86] dark:hover:text-sky-400 transition-colors">
              Programas
            </a>
            <a href="#noticias" className="hover:text-[#0C5A86] dark:hover:text-sky-400 transition-colors">
              Notícias
            </a>
            <a
        ...
        <div className="mt-10 pt-6 border-t border-[#EEF2F7] dark:border-white/5">
          <p className="text-xs text-slate-400 dark:text-slate-600">
            © {new Date().getFullYear()} CONSUDES · Todos os direitos reservados
          </p>
        </div>
