  ...
  return (
    <section className="relative bg-[#003B73] overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
        <span className="inline-block text-[#D9A441] text-xs font-bold tracking-[0.3em] uppercase mb-4">
          {label}
        </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 translate-y-[1px]">
        <svg viewBox="0 0 1440 40" className="w-full text-white dark:text-[#0d1624]" preserveAspectRatio="none">
