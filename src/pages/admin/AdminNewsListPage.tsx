                ...
                <div className="flex items-center justify-between gap-3 pt-1 border-t border-gray-50">
                  ...
                  >
                    ...
                    <span className={`text-xs font-medium ${item.status === 'published' ? 'text-green-600' : 'text-gray-400'}`}>
                      {actionLoading === item.id ? '…' : item.status === 'published' ? 'Visível' : 'Oculto'}
                    </span>
                  </button>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 text-left">
                  ...
                  <th className="px-5 py-3.5 font-medium text-gray-500 text-xs uppercase tracking-wide">Visível no site</th>
