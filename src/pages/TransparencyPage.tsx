...
export default function TransparencyPage() {
  ...
  const dateLocale: Record<string, string> = { pt: 'pt-BR', es: 'es-AR', en: 'en-US' };
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            ...
            >
              ...
              {REPORT_CATEGORIES.map((c) => (
                <option key={c.value} value={c.value}>{tp.categories[c.value]}</option>
              ))}
            </select>
            <select
              value={filterYear}
                      ...
                      >
                          ...
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            {doc.doc_date && (
                              <time dateTime={doc.doc_date} className="text-[11px] text-[#1F2937]/45 dark:text-white/35">
                                {new Date(doc.doc_date + 'T12:00:00').toLocaleDateString(dateLocale[lang], {
                        ...
                        {doc.file_url ? (
                          <div className="shrink-0 flex items-center gap-2">
                            ...
                            >
                              <IconEye />
                              <span className="hidden sm:inline">{tp.viewBtn}</span>
                            </button>
                            <a
                              href={doc.file_url}
                              download
                            ...
                            >
                              <IconDownload />
                              <span className="hidden sm:inline">{tp.downloadBtn}</span>
                            </a>
                          </div>
                        ) : (
