  ...
  return (
    <div
      ...
      {!failed ? (
        ...
        <span className="font-['Cormorant_Garamond'] font-semibold text-white/90">
          {initials}
        </span>
      )}
    </div>
...
function SectionHeading({ label, index }: { label: string; index: number }) {
  ...
  return (
    <div className="flex items-center gap-5 mb-8">
      <span
        aria-hidden="true"
        className="font-['Cormorant_Garamond'] text-5xl font-bold leading-none flex-shrink-0 select-none text-[#003B73]/35 dark:text-white/15 dark:text-white/[0.07]">
        {num}
      </span>
      <div className="flex-1">
        ...
        <div
          aria-hidden="true"
          className="h-px bg-gradient-to-r from-[#003B73]/15 via-[#D9A441]/30 to-transparent dark:from-white/10 dark:via-[#D9A441]/15"
        />
      </div>
    </div>
  );
...
export default function TeamPage() {
  ...
  const countriesCount = [...new Set(teamMembers.map(m => m.countryCode))]
    .length;
  ...
  return (
    <PageShell
      ...
      breadcrumbs={[
        { label: t.nav.institutional, href: "/institucional" },
        { label: t.nav.team }
      ]}>
      <section className="bg-gradient-to-b from-slate-50/60 to-white dark:bg-consudes-dark-body dark:bg-none py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16">
            <div className="flex-1">
              <p
                className="text-[11px] font-bold tracking-[0.5em] uppercase text-consudes-gold mb-4"
                aria-hidden="true">
                CONSUDES
              </p>
