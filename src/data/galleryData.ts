...
export const galleryAlbums: GalleryAlbum[] = [
    ...
    photos: [
      {
        filename: "01.webp",
        isHero: true,
        caption: "Portada oficial — II Juegos Sudamericanos 2019"
      },
  ...
  },
  {
    ...
    country: null,
    description: {
      es: "Encuentro institucional de los miembros y directivos de la CONSUDES. Un registro de las reuniones que dieron forma a las decisiones del deporte sordo sudamericano.",
      pt: "Encontro institucional dos membros e diretores da CONSUDES. Um registro das reuniões que moldaram as decisões do esporte surdo sul-americano.",
      en: "Institutional gathering of CONSUDES members and board. A record of the meetings that shaped the decisions of South American deaf sport."
    },
  ...
  },
  {
    ...
    country: "Ecuador",
    description: {
      es: "Tercera edición de los Interclubes en Ecuador, 2017. Registro documental del torneo con equipos de la región en plena disputa de la competencia.",
      pt: "Terceira edição dos Interclubes no Equador, 2017. Registro documental do torneio com equipes da região em plena disputa da competição.",
      en: "Third edition of the Interclubs in Ecuador, 2017. Documentary record of the tournament featuring regional teams in full competition."
    },
    category: "interclubes",
    tier: "T2",
    coverFile: "cover.webp",
    ...
    photos: [
      {
        filename: "01.webp",
        isHero: true,
        caption: "Cobertura de prensa — I Interclube 2005"
      },
      {
        filename: "02.webp",
        isHero: true,
        caption: "Diario — I Interclube 2005"
      },
      { filename: "03.webp" },
      { filename: "04.webp" },
      { filename: "05.webp" },
  ...
  },
  {
    ...
    country: null,
    description: {
      es: "Interclubes CONSUDES 2012. Fotografías de los equipos y delegaciones que disputaron esta edición de la competencia regional de clubes sordos.",
      pt: "Interclubes CONSUDES 2012. Fotografias das equipes e delegações que disputaram esta edição da competição regional de clubes surdos.",
      en: "CONSUDES Interclubs 2012. Photographs of the teams and delegations who competed in this edition of the regional deaf club tournament."
    },
    category: "interclubes",
    tier: "T3",
    coverFile: "cover.webp",
  ...
  },
  {
    ...
    country: "Brasil",
    description: {
      es: "XLVIII Asamblea Ordinaria de la CONSUDES celebrada en Brasil, 2017. Registro de la reunión plenaria de máxima autoridad del organismo continental del deporte sordo.",
      pt: "XLVIII Assembleia Ordinária da CONSUDES realizada no Brasil, 2017. Registro da reunião plenária de máxima autoridade do organismo continental do esporte surdo.",
      en: "XLVIII Ordinary General Assembly of CONSUDES held in Brazil, 2017. Record of the plenary meeting of the highest governing body of continental deaf sport."
    },
    category: "assembleias",
    tier: "T3",
    coverFile: "cover.webp",
  ...
  },
  {
    ...
    country: null,
    description: {
      es: "Colección de afiches oficiales de los grandes eventos CONSUDES: Juegos Sudamericanos, Interclubes y campeonatos continentales. Documentos gráficos que marcaron la historia del deporte sordo sudamericano.",
      pt: "Coleção de cartazes oficiais dos grandes eventos CONSUDES: Jogos Sul-Americanos, Interclubes e campeonatos continentais. Documentos gráficos que marcaram a história do esporte surdo sul-americano.",
      en: "Collection of official posters from major CONSUDES events: South American Games, Interclubs and continental championships. Graphic documents that marked the history of South American deaf sport."
    },
    category: "historico",
    tier: "T3",
    coverFile: "cover.webp",
    ...
    photos: [
      {
        filename: "01.webp",
        isHero: true,
        caption: "Afiche I Juegos Sudamericanos"
      },
  ...
  },
  {
    ...
    country: null,
    description: {
      es: "Archivo fotográfico de los presidentes que condujeron la CONSUDES a lo largo de su historia. Un reconocimiento a quienes construyeron y representaron el deporte sordo sudamericano.",
      pt: "Arquivo fotográfico dos presidentes que conduziram a CONSUDES ao longo de sua história. Um reconhecimento a quem construiu e representou o esporte surdo sul-americano.",
      en: "Photographic archive of the presidents who led CONSUDES throughout its history. A tribute to those who built and represented South American deaf sport."
    },
    category: "historico",
    tier: "T3",
    coverFile: "cover.webp",
  ...
  },
  {
    ...
    country: null,
    description: {
      es: "Galería de retratos de los integrantes de la directiva de la CONSUDES. Los rostros de quienes representaron y gobernaron el deporte sordo continental.",
      pt: "Galeria de retratos dos integrantes da diretoria da CONSUDES. Os rostos de quem representou e governou o esporte surdo continental.",
      en: "Portrait gallery of CONSUDES board members. The faces of those who represented and governed continental deaf sport."
    },
    category: "historico",
    tier: "T3",
    coverFile: "03.webp",
  ...
  },
  {
    ...
    country: "Ecuador",
    description: {
      es: "Interclubes disputados en Ecuador, 2019. Registro fotográfico de la edición más reciente del torneo regional de clubes sordos antes de la pandemia.",
      pt: "Interclubes disputados no Equador, 2019. Registro fotográfico da edição mais recente do torneio regional de clubes surdos antes da pandemia.",
      en: "Interclubs held in Ecuador, 2019. Photographic record of the most recent edition of the regional deaf club tournament before the pandemic."
    },
    category: "interclubes",
    tier: "T3",
    coverFile: "cover.webp",
